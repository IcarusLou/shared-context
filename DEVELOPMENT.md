...
- **M4 完整链路：未实现** — #117 已完成 Candidate submission 幂等门禁，#156/#157/#158/#159 已完成可验证 WorkEpisode/Capture、显式 AgentCheckpoint、确定性 Candidate Builder 与非权威分析/Space 推荐；自动聚合（#163）和 Candidate confirm/list/get/discard 尚未实现。
