...
- **#151：已实现** — Runtime 内部 API 持久化 Repository-scoped TaskArtifactFocus、CAS、dedup、active/superseded 与历史；Search 只消费 Active Focus。
- **#152：未实现** — 尚未提供 MCP/Skill Focus 提交入口。
