...
- Enabled PostTool Hook 不运行 Git、Scanner、Graph rebuild，也不发起 ArtifactFocusQuery；它只把安全的机械工具分类合并成非事实、非定位的 TaskSignals。TaskSignal 可影响 Working Intent retrieval，但不是工程 Evidence；工作 Agent 必须直接撰写高价值 Claim Evidence。
