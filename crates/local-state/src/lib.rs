//! Non-authoritative user configuration, workspace query hints, short-lived
//! capture breadcrumbs, and the shared Secret/PII scanner.
//!
...
pub use config::{UserConfigStore, WorkspaceBinding, WorkspaceQueryHint};
pub use privacy::{PrivacyFinding, PrivacyFindingKind, PrivacyScan, PrivacyScanner, RedactedText};
pub use sctx_domain::{Error, ErrorKind, Result, SpaceId};
