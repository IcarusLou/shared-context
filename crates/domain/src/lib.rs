...
pub use episode::{
    ...
    CandidateSpaceRecommendationPath, CheckpointClaim, CheckpointEvidenceRef, CheckpointUnknown,
    ContextCandidate, ContextRevisionRef, ContextUseDisposition, IntentRevisionRange,
    NonLocatingSignalRef, NormalizedWorkObservation, RecommendedSpaceRole, TestOutcomeStatus,
